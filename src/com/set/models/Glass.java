 ...
 * @param  </Glass> the type of elements of this class
...
public class Glass implements Comparable<Glass> {
    ...
    public Glass(String name, int price) {
        this.name = name;
        this.price = price;
    }
    ...
    public boolean equals(Object o) {
        ...
        Glass glass=(Glass) o;
        return price ==glass.price &&
                name.equals(glass.name);
    }
    ...
    public int compareTo(Glass o) {
        return Comparator.comparing(Glass::getName)
                .thenComparing(Glass::getPrice)
                .compare(this, o);
    }
}
